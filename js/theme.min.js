(() => {
  // ns-hugo:C:\Users\Whili\OneDrive\Projects\Website-hugo\myblog\themes\FixIt\assets\js\util.js
  var Util = class {
      ...
      this.util.forEach(document.querySelectorAll(".highlight > .chroma:not([data-init])"), ($chroma) => {
        ...
        if ($codeElements.length) {
          ...
          $title.insertAdjacentHTML(
            "afterbegin",
            $chroma.parentNode.title ? `<i class="arrow fa-solid fa-chevron-right fa-fw" aria-hidden="true"></i><span class="title-inner">${$chroma.parentNode.title}</span>` : '<i class="arrow fa-solid fa-chevron-right fa-fw" aria-hidden="true"></i>'
          );
